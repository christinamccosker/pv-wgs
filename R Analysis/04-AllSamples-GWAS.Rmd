...
pca.data <-
  ...
  mutate(coverage = ifelse(coverage == "high", "High", "Low"))
...
pca <- 
  ggplot(pca.data, aes(x=x, y=y, shape = coverage)) +
  geom_point() +
...
ggsave("Figures/allsamples_popstruct_pca.jpeg", pca, 
