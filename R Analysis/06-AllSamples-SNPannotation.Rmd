...
2026 Update: biomaRt/Ensembl connection no longer supported. Using archive and exporting as RDS object to preserve functionality of this script.  
```{r}
snp_ensembl <-
...
# 
# saveRDS(ensembl, file = "Output Files/ensembl_mart.rds")

ensembl <-
  readRDS("Output Files/ensembl_mart.rds")
